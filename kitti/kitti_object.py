...
def dataset_viz():
    ...
    split = 'training'
    save2ddir = os.path.join(
        ROOT_DIR, '/scratch/jain.van/ACV/dataset/KITTI/object', split, 'vis2d')
    save3ddir = os.path.join(
        ROOT_DIR, '/scratch/jain.van/ACV/dataset/KITTI/object', split, 'vis3d')
...
def dataset_viz_pred(pred_label_dir):
    ...
    save2ddir_pred = os.path.join(
        ROOT_DIR, '/scratch/jain.van/ACV/dataset/KITTI/object', split, 'vis2d_pred')
    save3ddir_pred = os.path.join(
        ROOT_DIR, '/scratch/jain.van/ACV/dataset/KITTI/object', split, 'vis3d_pred')
    if os.path.isdir(save2ddir) == True:
        print('previous save2ddir found. deleting...')
        shutil.rmtree(save2ddir)
    os.makedirs(save2ddir)
