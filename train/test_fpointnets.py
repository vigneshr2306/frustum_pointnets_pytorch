...
if FLAGS.model == 'frustum_pointnets_v1':
    ...
    FrustumPointNet = FrustumPointNetv1(
        n_classes=n_classes, n_channel=4).cuda()
...
if __name__ == '__main__':
    ...
    train/kitti_eval/evaluate_object_3d_offline /scratch/jain.van/ACV/dataset/KITTI/object/training/label_2/ train/detection_results_v1
    '''
    ...
    # from rgb_detection, caronly
     ...
     train/kitti_eval/evaluate_object_3d_offline /scratch/jain.van/ACV/dataset/KITTI/object/training/label_2/ train/kitti_caronly_v1_fromrgb 
    ...
    train/kitti_eval/evaluate_object_3d_offline /scratch/jain.van/ACV/dataset/KITTI/object/training/label_2/ train/kitti_caronly_v1
